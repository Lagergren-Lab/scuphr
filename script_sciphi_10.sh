		...
		do
			...
			do
				...
				do
					...
					job_file="${DATA_DIR}/${EXP_NAME}/script_sciphi_normal.sh"
...
#SBATCH -t 168:00:00
#SBATCH -J ${EXP_NAME}
#SBATCH -e ${RESULT_DIR}/${EXP_NAME}/sciphi_normal_err.txt
#SBATCH -o ${RESULT_DIR}/${EXP_NAME}/sciphi_normal_out.txt
