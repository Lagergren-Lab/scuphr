...
CNV_RATIO=0
for TEST_PADO in 0.112
do
	for TEST_PAE in 0.00062
	do
		for NUM_CELLS in 50 
		do
			for AVG_MUT in 10
					...
					do
						...
						do
							...
							do
								...
								job_file="${DATA_DIR}/${EXP_NAME}/dbc_all_25k_0.sh"
...
#SBATCH -t 12:00:00
#SBATCH -J ${EXP_NAME}
#SBATCH -e ${DATA_DIR}/${EXP_NAME}/dbc_all_25000_0_err.txt
#SBATCH -o ${DATA_DIR}/${EXP_NAME}/dbc_all_25000_0_out.txt
...
python3 analyse_dbc_json.py ${DATA_DIR}/${EXP_NAME}/ --seed_val $SEED_VAL --data_type ${DATA_TYPE} --p_ado $TEST_PADO --p_ae $TEST_PAE --print_status 0 --scuphr_strategy $SCUPHR_STRATEGY --output_dir ${RESULT_DIR}/${EXP_NAME}/${TEST_PADO}_${TEST_PAE}/ --pos_range_min 25000 --pos_range_max 0
wait
